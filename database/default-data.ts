...
export const defaultAssets = [
  ...
  },
  {
    ...
    shortLocation: 'Magelang',
    area: 'semi outdoor',
    fasilitas: ['Sound System', 'Jasa Fotografi', 'Genset (disewakan terpisah)'],
  ...
  },
  {
    ...
    shortLocation: 'Magelang',
    area: 'semi outdoor',
    fasilitas: ['Sound system ± 25 ribu watt (disewakan terpisah)', 'Lampu panorama candi (disewakan terpisah)', 'Genset (disewakan terpisah)'],
    tarif: 'Rp 15.000.000/hari',
    overtime: 'Rp 3.500.000/hari',
    fasilitasTambahan: ['Sound System', 'Genset', 'Lampu Panorama'],
    ketentuanUmum: [],
