...
export const tableConfigs = {
  ...
  tb_banner : ['id', 'title','subtitle','image','button_label_1','button_url_1','button_label_2','button_url_2','start_publish_date','end_publish_date','is_active','is_approved','is_rejected','created_at','created_by','updated_at','updated_by'],
  ...
  tb_media: ['id','title','image_url','file_url','categories','subtitle','description','source','author','is_active', 'is_approved','is_rejected','created_at','created_by','updated_at','updated_by','published_date'],
  tb_sites:['id','name','type','category','subtitle','description','address',
    ...
    'latitude','longitude','is_active', 'is_approved','is_rejected','created_at','created_by','updated_at','updated_by'],
  tb_events:['id','name','category','subtitle','description','sites_id','location','address','start_published_date','end_published_date','start_date','end_date','contact','website','banner_img','ticket_price','ticket_url','is_active','is_approved','is_rejected','created_at','created_by','updated_at','updated_by'],
  ...
  tb_sop: ['id','title','subtitle','description','publish_date','category','document_url','author','is_active','is_approved','is_rejected','created_at','created_by','updated_at','updated_by']
