...
export const tableConfigs = {
  ...
  tb_banner : ['id', 'title','subtitle','image','image_landscape','image_portrait','button_label_1','button_url_1','button_label_2','button_url_2','start_publish_date','end_publish_date','display_order','is_active','is_approved','is_rejected','reason_rejected','created_at','created_by','updated_at','updated_by'],
  ...
  tb_site_settings: ['id','key','value','label','created_at','created_by','updated_at','updated_by'],
  tb_menu: ['id','label','label_en','href','parent_id','display_order','is_active','created_at','created_by','updated_at','updated_by'],
  tb_sites:['id','name','type','category','subtitle','description','address',
    'opening_hours','phone','whatsapp','website','facilities','img_banner','image_landscape','image_portrait','ticket_price','ticket_url','collection',
    'latitude','longitude','display_order','is_active', 'is_approved','is_rejected','reason_rejected','created_at','created_by','updated_at','updated_by'],
  tb_events:['id','name','category','subtitle','description','sites_id','location','address','start_published_date','end_published_date','start_date','end_date','contact','website','banner_img','image_landscape','image_portrait','ticket_price','ticket_url','is_active','is_approved','is_rejected','reason_rejected','created_at','created_by','updated_at','updated_by'],
  ...
  tb_ppid_documents: ['id', 'title', 'description', 'file_url', 'file_type', 'file_size', 'display_order', 'is_active', 'created_by', 'created_at', 'updated_by', 'updated_at']
};
