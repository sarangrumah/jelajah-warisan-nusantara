...
export const tableConfigs = {
  ...
  tb_banner : ['id', 'title','subtitle','image','button_label_1','button_url_1','button_label_2','button_url_2','start_publish_date','end_publish_date','display_order','is_active','is_approved','is_rejected','reason_rejected','created_at','created_by','updated_at','updated_by'],
