  ...
  en: {
    translation: {
      ...
      nav: {
        ...
        beritaPublikasi: "News & Publications",
        dokumenPublikasi: "Publication Documents",
      ...
      mow: {
        ...
        subtitle: "Memory of the World (MoW) is the world's collective memory that plays an important role in human history as a reminder of significant events recorded in documentary heritage.",
  ...
  id: {
    translation: {
      ...
      nav: {
        ...
        beritaPublikasi: "Berita & Publikasi",
        dokumenPublikasi: "Dokumen Publikasi",
      ...
      mow: {
        title: "Memori Dunia",
        subtitle: "Memory of the World (MoW) adalah ingatan kolektif dunia yang berperan penting dalam sejarah umat manusia sebagai pengingat peristiwa-peristiwa penting yang tercatat dalam warisan dokumenter.",
